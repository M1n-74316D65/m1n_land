...
export const projects = [
  {
    ...
    icon: Terminal,
    label: 'Pastol',
    description: 'A command-line tool for paste.lol.',
    category: 'Projects',
    tags: ['Rust', 'CLI'],
  },
  {
    ...
    icon: FolderCog,
    label: 'rusted-yadm',
    description: 'A Rust command-line tool to manage dotfiles.',
    category: 'Projects',
    tags: ['Rust', 'CLI'],
  },
  {
    ...
    description: 'A stateless password manager. Use one primary password. No sync required.',
    category: 'Projects',
    tags: ['Rust', 'Security'],
  },
  {
